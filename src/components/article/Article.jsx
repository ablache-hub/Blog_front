...
export default function Article() {
    ...
    useEffect(() => {
        const getArticle = async () => {
            await axios.get(process.env.REACT_APP_URL_API + "/api/article/get/" + pathUrl)
                .then((response) => {
   ...
   const handleDelete = async () => {
        await axios.delete(process.env.REACT_APP_URL_API + "/api/article/delete/" + fetchArticle.id,
            {
            ...
            <div className="singlePostWrapper">
                <img
                    src={fetchArticle.articlePicture ?
                        process.env.REACT_APP_URL_API + "/api/file/get/getById/" + fetchArticle.articlePicture.id : "https://orgaphenix.com/wp-content/uploads/2020/01/secrets-photo-profil-linkedin.jpeg"}
