...
export default function Write() {
    ...
    const handleSubmit = async (e) => {
        ...
        if (!title || !contenu || !categorie.length) {
            ...
            await axios.post(process.env.REACT_APP_URL_API + "/api/article/new/",
                newArticle,
                {
                    headers: {
    ...
    //         await axios.post(process.env.REACT_APP_URL_API + "/api/file/user/" + username + "/upload", bodyFormData,
    //             {
    //                 headers: {
    //                     'Authorization': decryptData(token),
    //                     'Content-Type': 'multipart/form-data',
